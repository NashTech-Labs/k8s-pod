...
def create_pod(cluster_details,yaml_body=None,namespace="default"):
    ...
    try:
        ...
        yaml_data=open("pod-create.yml", "rb").read().decode('utf-8')
...
def update_pod(cluster_details,k8s_object_name=None,yaml_body=None,namespace="default"):
    ...
    try:
        ...
        yaml_data=open("pod-update.yml", "rb").read().decode('utf-8')
        yaml_body=yaml.safe_load(yaml_data)
...
if __name__ == '__main__':
    ...
    get_pods(cluster_details)
    # create_pod(cluster_details)
    # update_pod(cluster_details,k8s_object_name="nginx-pod-yamika")
    # delete_pod(cluster_details,k8s_object_name="nginx-pod-yamika")